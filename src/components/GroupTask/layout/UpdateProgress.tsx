...
// import { issueDetail, updateTaskProgress } from "../api/api";
import { useQuill } from "react-quilljs";
import { Textarea } from "@/components/ui/textarea";
import { IIssue, TaskComponent } from "../utils/utils";
import { Button } from "@/components/ui/button";
import { useToast } from "@/hooks/use-toast";
import { taskDetail, updateTaskProgress } from "../api/api";
...
const UpdateProgress = () => {
  ...
  const getQuest = async () => {
    const response = await taskDetail(
      projectId,
      issueId,
      organizationId,
      groupId
  ...
  const updateTaskData = async (e: React.MouseEvent<HTMLButtonElement>) => {
    const req = await updateTaskProgress(e, projectId, issueId, organizationId, groupId, data);
