...
import { IOrganizationUser } from "@/app/Organization/utils/utils";
import { getOrganizationUsers } from "@/app/Organization/api/api";
...
const AddUser = () => {
  ...
  const fetchOrganizationUsers = async (): Promise<IOrganizationUser[]|any> => {
    try {
