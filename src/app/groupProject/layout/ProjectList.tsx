...
import { IProject } from "@/app/Project/utils/utils";
...
const ProjectList = ({
  ...
  const handleClick = (id: string) => {
    navigate(`/organization/${organizationId}/group/${groupId}/project/${id}`);
  };
  return (
    <>
      {isLoading ? (
        ...
        <div>
          {items.length === 0 ? (
            ...
            <div className="grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 max-[500px]:grid-cols-1 gap-5">
              {items.map((project) => (
                <div>
                  <div id={project.id}>
                    <Card
